...
<html lang="en">
    ...
    <hr>
      ...
      <div class="col-md-9 personal-info">
        ...
        <form class="form-horizontal" role="form" method="post" action="act?action=saveNewUser">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input autocomplete="off" class="form-control" type="text" name="login">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Password:</label>
            <div class="col-lg-8">
              <input autocomplete="off" class="form-control" type="text" name="password">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Birth date:</label>
            <div class="col-lg-8">
              <input autocomplete="off" class="form-control" type="text" name="date" placeholder="yyyy-mm-dd">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Role:</label>
            <div class="col-lg-8">
              <input autocomplete="off" class="form-control" type="text" name="role">
            </div>
          </div>
          <div class="form-group">
